...
<div class="flex justify-between items-center mb-4">
    <p class="text-gray-500 text-sm">Daftar dosen pengampu</p>
    <a href="{{ route('admin.dosen.create') }}" class="bg-blue-800 text-white px-4 py-2 rounded-lg text-sm hover:bg-blue-900">+ Tambah</a>
</div>
    ...
    <table class="w-full text-sm">
        <thead class="bg-gray-50">
            <tr class="text-left text-gray-500">
                ...
                <th class="px-5 py-3">NIP/NIDN</th>
        ...
        <tbody>
            ...
            <tr class="border-t border-gray-50 hover:bg-gray-50">
                ...
                <td class="px-5 py-3 text-gray-500">{{ $item->nip_nidn ?? '-' }}</td>
                ...
                <td class="px-5 py-3 flex gap-2">
                    ...
                    <form method="POST" action="{{ route('admin.dosen.destroy', $item) }}" onsubmit="return confirm('Hapus?')">
                        @csrf @method('DELETE')
